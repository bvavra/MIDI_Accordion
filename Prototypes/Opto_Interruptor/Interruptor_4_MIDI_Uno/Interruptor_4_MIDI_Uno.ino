...
void loop()
{
  for (int i=0; i<sizeof(DIGITAL_COLUMNS);i++){ 
    ...
    //For some reason w/o a 6ms delay both notes get played
    //Let's see if we can figure out a way to fix this...
    delayMicroseconds(500);//Orig val: 500 - TODO: play around with this number a bit
    delay(5);
